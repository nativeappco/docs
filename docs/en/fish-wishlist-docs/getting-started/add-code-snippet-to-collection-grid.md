...
3.  **Insert the Wishlist Button Code**:
    ...
    *   Paste the following code snippet within each product card section where you'd like the button:
            ...
            <wishlist-button class="position-absolute top-right" data-variant-id="{{ product.variants | map: "id" | join: "," }}"></wishlist-button>
...
<figure><p><img class="tiptap-image" src="../../.gitbook/assets/image (4).png" alt=""></p><figcaption></figcaption></figure>