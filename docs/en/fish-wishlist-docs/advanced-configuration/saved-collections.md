...
# Save Collections to Wishlist – User Guide
...
Your customers can save any collection to their wishlist with a single click. When logged in, collections save instantly and appear in their wishlist drawer under a "Saved Collections" section. If a customer clicks the button while logged out, they'll be prompted to log in first. From the wishlist, they can view all saved collections with images and titles, and remove collections anytime. This gives them a quick way to bookmark categories, brands, and product ranges for future browsing.
...
2.  **Navigate to Apps > Fish Wishlist > Settings**.
