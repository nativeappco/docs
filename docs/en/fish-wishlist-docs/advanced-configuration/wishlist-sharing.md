...
seoTitle: Wishlist Sharing | Fish Wishlist
seoDescription: Let customers share their wishlists via a link. Stored as Shopify Metaobjects — editable from admin. Use for gift registries, influencer lists, and curated collections.
...
Go to **Fish Wishlist > Settings** and turn on **Share Wishlist Button**. A share icon will appear next to each wishlist for logged-in customers.

* * *

## How it works for customers

1.  Customer signs in and opens their wishlist
2.  They press the share button to generate a unique share link
3.  They can copy the link or share it directly
4.  Anyone with the link can view the wishlist on a dedicated page

> Customers must be signed in to generate a share link.
